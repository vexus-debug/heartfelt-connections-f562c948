...
const ProductCard = ({ product }: { product: typeof products[0] }) => {
  ...
  return (
    <div className="bg-card rounded-2xl border border-border overflow-hidden group hover:shadow-xl transition-all duration-300 flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="mt-auto pt-3 border-t border-border/60 flex items-center justify-between gap-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 bg-primary text-primary-foreground px-3.5 py-2 rounded-lg text-[11px] font-bold hover:bg-primary-dark transition-colors shrink-0"
          >
