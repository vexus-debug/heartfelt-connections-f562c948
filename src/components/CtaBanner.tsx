  ...
  <section className="py-16 md:py-20 bg-gradient-to-br from-primary via-primary-dark to-primary relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 relative z-10 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <a
          href="#quote"
          className="group inline-flex items-center justify-center gap-2 bg-teal text-accent-foreground px-8 py-4 rounded-xl font-bold hover:brightness-110 transition-all text-sm shadow-lg shadow-teal/25"
        >
