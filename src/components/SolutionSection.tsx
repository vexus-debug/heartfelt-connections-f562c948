...
const SolutionSection = () => (
  <section className="py-20 md:py-28 bg-gradient-to-b from-primary/[0.03] to-background relative overflow-hidden">
    ...
    <div className="absolute bottom-0 right-0 w-64 h-64 bg-teal/5 rounded-full blur-3xl translate-x-1/3 translate-y-1/3" />
    ...
    <div className="container mx-auto px-4 relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        ...
        {/* Step 2 */}
        <div className="relative bg-card rounded-2xl p-7 border border-border hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
          <div className="absolute -top-3 -left-3 w-8 h-8 rounded-full bg-primary text-primary-foreground text-sm font-bold flex items-center justify-center font-display">2</div>
          ...
          <span className="text-teal text-sm font-semibold">Usually same-day</span>
        </div>
