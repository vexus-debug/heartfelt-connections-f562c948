  ...
  <section className="relative min-h-screen flex items-center overflow-hidden">
    ...
    <div className="container mx-auto px-4 relative z-10 pt-24 pb-12">
      <div className="max-w-3xl">
        {/* Badge */}
        <div className="inline-flex items-center gap-2.5 bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/15 rounded-full px-4 py-2 text-sm font-medium text-primary-foreground/90 mb-8 animate-fade-up">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-extrabold text-primary-foreground leading-[1.08] mb-6 animate-fade-up" style={{ animationDelay: '0.1s' }}>
          ...
          <span className="relative inline-block">
            <span className="text-gradient bg-gradient-to-r from-teal-light to-teal bg-clip-text text-transparent">
              Better Equipment
            </span>
            <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 300 12" fill="none">
              <path d="M2 8 C60 2, 140 2, 298 8" stroke="hsl(165 60% 42%)" strokeWidth="3" strokeLinecap="round" opacity="0.5" />
            </svg>
          </span>
        </h1>
        ...
        <div className="flex flex-wrap gap-4 mb-16 animate-fade-up" style={{ animationDelay: '0.3s' }}>
          <a
            href="#quote"
            className="group inline-flex items-center gap-2 bg-teal text-accent-foreground px-7 py-4 rounded-xl font-bold hover:brightness-110 transition-all text-sm shadow-lg shadow-teal/25"
          >
            Get Your Free Quote
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 animate-fade-up" style={{ animationDelay: '0.4s' }}>
        {stats.map((s) => (
          <div key={s.label} className="bg-primary-foreground/[0.07] backdrop-blur-sm border border-primary-foreground/10 rounded-2xl p-5 text-center">
