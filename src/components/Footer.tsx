      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <div className="space-y-2.5 text-sm text-background/70">
            <a href="#products" className="block hover:text-teal transition-colors">Products</a>
            <a href="#why-us" className="block hover:text-teal transition-colors">Why Yorlad</a>
            <a href="#testimonials" className="block hover:text-teal transition-colors">Testimonials</a>
            <a href="#quote" className="block hover:text-teal transition-colors">Request a Quote</a>
          </div>
        </div>
      </div>
